          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:20px">
            <thead>
              <tr style="background:#f8fafc">
                <th style="padding:8px;text-align:left;font-size:0.75rem;color:#888;text-transform:uppercase">Item</th>
                <th style="padding:8px;text-align:center;font-size:0.75rem;color:#888;text-transform:uppercase">Qty</th>
                <th style="padding:8px;text-align:right;font-size:0.75rem;color:#888;text-transform:uppercase">Price</th>
              </tr>
            </thead>
    ...
    html: `
      <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:560px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:8px;overflow:hidden">
        ...
        <div style="padding:28px 32px">
          ...
          <p style="color:#666;font-size:0.88rem;margin:0 0 24px;line-height:1.6">A customer just placed an order for your product(s). Please prepare it for delivery.</p>
          ...
          <a href="${process.env.FRONTEND_URL}/seller" style="display:block;background:#059669;color:white;text-align:center;padding:13px;border-radius:4px;text-decoration:none;font-weight:700;font-size:0.9rem">View Order in Seller Dashboard →</a>
        </div>
        <div style="background:#f8fafc;padding:16px 32px;border-top:1px solid #eee">
          <p style="color:#cbd5e1;font-size:0.72rem;margin:0;text-align:center">© ${new Date().getFullYear()} Gen.Z Nepal · Crafted in Kathmandu</p>
        </div>
